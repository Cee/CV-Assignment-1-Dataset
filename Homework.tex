...
\begin{enumerate}[label=A\arabic*)]
	\item Image formation 
		...
		\end{itemize}
		\pagebreak
	\item Connectivity foreground/background \begin{enumerate}[label=(\alph*)]
			\item
...
%			\item The \textit{Popeyes\textsuperscript{\tiny\textregistered} Fried Chicken} image %taken by myself:
			\item The Pork Image (Algorithm Part):
				...
				\begin{figure}[h!]
					\begin{minipage}{0.48\textwidth}
			            ...
			            \captionof{figure}{The original image}
					\end{minipage}
					\hfill
					\begin{minipage}{0.48\textwidth}
						\centering
						\includegraphics[width=20em]{Pork/Gray.png}
						\captionof{figure}{The gray-scaled image}
					\end{minipage}
				\end{figure}
				\begin{figure}[h!]
					\centering
					\includegraphics[width=0.6\linewidth]{Pork/Histogram.png}
		            \captionof{figure}{Histogram (using \texttt{matplotlib.plot}) of the gray-scaled image}
				\end{figure}
				\begin{figure}[h!]
					\begin{minipage}{0.48\textwidth}
						\centering
						\includegraphics[width=0.9\linewidth]{Pork/Histogram(bin-256).png}
			            \captionof{figure}{Histogram (using \texttt{matplotlib.hist}) of the gray-scaled image, \# of bins = 256 (L)}					\end{minipage}
					\hfill
					\begin{minipage}{0.48\textwidth}
						\centering
						\includegraphics[width=0.9\linewidth]{Pork/Histogram(bin-64).png}
			            \captionof{figure}{Histogram (using \texttt{matplotlib.hist}) of the gray-scaled image, \# of bins = 64 ($\frac{L}{4}$)}
					\end{minipage}
				\end{figure}
				\begin{figure}[h!]
					\begin{minipage}{0.48\textwidth}
						\centering
						\includegraphics[width=0.9\linewidth]{Pork/PDF.png}
			            \captionof{figure}{Probability Density Function (PDF) of the gray-scaled image}
					\end{minipage}
					\hfill
					\begin{minipage}{0.48\textwidth}
						\centering
						\includegraphics[width=0.9\linewidth]{Pork/CDF.png}
			            \captionof{figure}{Cumulative Distribution Function (CDF) of the gray-scaled image}
					\end{minipage}
				\end{figure}
				\pagebreak
			\item The Mountain Image from OpenCV Website (Comparison part):
				...
				\begin{figure}[h!]
					...
					\begin{minipage}{0.32\textwidth}
			            ...
			            \captionof{figure}{The clipped image}
					\end{minipage}
				\end{figure}
				\begin{figure}[h!]
					\centering
				...
				\begin{figure}[h!]
					\begin{minipage}{0.48\textwidth}
						\centering
						\includegraphics[width=0.9\linewidth]{Hist/Histogram(bin-256).png}
			            \captionof{figure}{Histogram (using \texttt{matplotlib.hist}) of the gray-scaled image, \# of bins = 256 (L)}					\end{minipage}
					\hfill
					\begin{minipage}{0.48\textwidth}
						\centering
						\includegraphics[width=0.9\linewidth]{Hist/Histogram(bin-64).png}
			            \captionof{figure}{Histogram (using \texttt{matplotlib.hist}) of the gray-scaled image, \# of bins = 64 ($\frac{L}{4}$)}
					\end{minipage}
				\end{figure}
				\begin{figure}[h!]
					\begin{minipage}{0.48\textwidth}
						\centering
						\includegraphics[width=0.9\linewidth]{Hist/PDF.png}
			            \captionof{figure}{Probability Density Function (PDF) of the gray-scaled image}
					\end{minipage}
					\hfill
					\begin{minipage}{0.48\textwidth}
						\centering
						\includegraphics[width=0.9\linewidth]{Hist/CDF.png}
			            \captionof{figure}{Cumulative Distribution Function (CDF) of the gray-scaled image}
					\end{minipage}
				\end{figure}
		\end{enumerate}
	...
	\item Histogram Equalization 
		...
		\begin{figure}[h!]
            ...
            \captionof{figure}{Histogram Equalization Algorithm}
		\end{figure}
		...
		\begin{figure}[h!]
			...
			\begin{minipage}{0.32\textwidth}
	            ...
	            \captionof{figure}{The equalized image}
			\end{minipage}
		\end{figure}
		\begin{figure}[h!]
			\begin{minipage}{0.24\textwidth}
	            ...
	            \captionof{figure}{Histogram, \# of bins = 256 (L)}					\end{minipage}
			\hfill
			\begin{minipage}{0.24\textwidth}
				\centering
				\includegraphics[width=0.9\linewidth]{Hist/Equalized/Histogram(bin-64).png}
	            \captionof{figure}{Histogram, \# of bins = 64 ($\frac{L}{4}$)}
			\end{minipage}
			\hfill
			\begin{minipage}{0.24\textwidth}
				\centering
				\includegraphics[width=0.9\linewidth]{Hist/Equalized/Histogram(bin-32).png}
	            \captionof{figure}{Histogram, \# of bins = 32 ($\frac{L}{8}$)}
			\end{minipage}
			\hfill
			\begin{minipage}{0.24\textwidth}
				\centering
				\includegraphics[width=0.9\linewidth]{Hist/Equalized/Histogram(bin-16).png}
	            \captionof{figure}{Histogram, \# of bins = 16 ($\frac{L}{16}$)}
			\end{minipage}
		\end{figure}
		\begin{figure}[h!]
			\begin{minipage}{0.48\textwidth}
				\centering
				\includegraphics[width=0.9\linewidth]{Hist/Equalized/PDF.png}
	            \captionof{figure}{Probability Density Function (PDF) of the equalized gray-scaled image}
			\end{minipage}
			\hfill
			\begin{minipage}{0.48\textwidth}
				\centering
				\includegraphics[width=0.9\linewidth]{Hist/Equalized/CDF.png}
	            \captionof{figure}{Cumulative Distribution Function (CDF) of the equalized gray-scaled image}
			\end{minipage}
		\end{figure}
	...
	\item Histogram Matching
		...
		\begin{figure}[h!]
            ...
            \captionof{figure}{Histogram Matching Algorithm}
		\end{figure}
		\\
		\\
		...
		\begin{figure}[h!]
			\begin{minipage}{0.48\textwidth}
	            ...
	            \captionof{figure}{The original Pork image}
			\end{minipage}
			\hfill
			\begin{minipage}{0.48\textwidth}
				\centering
				\includegraphics[width=0.6\linewidth]{Pork/Gray.png}
				\captionof{figure}{The gray-scaled Pork image}
			\end{minipage}
		\end{figure}
		\begin{figure}[h!]
			\begin{minipage}{0.32\textwidth}
			...
			\begin{minipage}{0.32\textwidth}
	            ...
	            \captionof{figure}{The matched image}
			\end{minipage}
		\end{figure}
		\\
		\\
